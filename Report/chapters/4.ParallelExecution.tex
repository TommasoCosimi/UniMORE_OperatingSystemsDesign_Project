...
Lo svantaggio più ovvio è che non essendo più necessariamente in grado di assegnare un singolo \textit{Thread} a ogni \textit{Task} dell'utente, il grado di parallelismo raggiungibile implementando una soluzione come questa va ovviamente a ridursi. \par
