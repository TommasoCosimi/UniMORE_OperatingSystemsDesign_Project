...
Si riporta a seguire un esempio di Programma e della sua relativa esecuzione al fine di illustrare le proprietà di Sincronizzazione e di Rientranza del Costrutto descritto.
...
Viene reimplementato l'esempio visto per il Costrutto \texttt{synchronized} tramite l'utilizzo dei \texttt{Lock}.
