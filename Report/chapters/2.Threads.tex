...
Si noti come l'esecuzione del \textit{Thread} principale termini prima di quella degli altri Processi Leggeri da lui generati. Questa circostanza tuttavia non limita in alcun modo questi ultimi, che continueranno la loro esecuzione fino alla rispettiva terminazione.
